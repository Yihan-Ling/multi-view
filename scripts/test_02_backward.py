...
def main() -> None:
    ...
    grad_checks = {
        "backbone.conv1.weight": model.backbone.conv1.weight.grad,
        "backbone.layer4[-1].conv3.weight": model.backbone.layer4[-1].conv3.weight.grad,
        "backbone.deconv_head[0].weight": model.backbone.deconv_head[0].weight.grad,
        "head.mlp[-1].weight": model.head.mlp[-1].weight.grad,
    }
